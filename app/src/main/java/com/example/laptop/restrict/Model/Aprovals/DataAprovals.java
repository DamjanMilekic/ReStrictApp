...
public class DataAprovals implements Serializable {
     ...
     * @param firstName
     */
    public DataAprovals(Integer userId, String email, String title, String firstName, String lastName, String image, String role, String companyName, String phone, Boolean client, Boolean uploader, Object approvalId, Integer approved, String compositeKey) {
        super();
        this.userId = userId;
        this.email = email;
        this.title = title;
